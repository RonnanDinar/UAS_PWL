    ...
    <?php foreach ($mobil as $m): ?>
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm h-100">
                <?php
                    // gunakan default gambar kalau kosong
                    $gambar = $m['gambar'] ?? 'default.jpg';
                ?>
                <img src="<?= base_url('uploads/mobil/' . $gambar) ?>" class="card-img-top" alt="<?= esc($m['nama_mobil']) ?>" style="height: 200px; object-fit: cover;">
                <div class="card-body">
                    ...
                    <a href="/mobil/sewa/<?= $m['id'] ?>" class="btn btn-primary w-100">Sewa Sekarang</a>
                </div>
            </div>
        </div>
        <?php endif; ?>
